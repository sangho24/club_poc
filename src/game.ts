...
export const PLATE_SEQUENCE: PlateAppearance[] = [
  {
    situation: { ...base, inning: 8, outs: 0, bases: bases(false, false, false), balls: 0, strikes: 0 },
    batterId: 'mhb',
    pitcherId: 'lcg',
  ...
  {
    situation: { ...base, inning: 8, outs: 0, bases: bases(true, false, false), balls: 1, strikes: 1 },
    batterId: 'ces',
    pitcherId: 'lcg',
  ...
  {
    situation: { ...base, inning: 8, outs: 1, bases: bases(true, false, false), balls: 2, strikes: 1 },
    batterId: 'nsh',
    pitcherId: 'lcg',
  ...
  {
    situation: { ...base, inning: 8, outs: 1, bases: bases(false, true, true), balls: 0, strikes: 0 },
    batterId: 'flo',
    pitcherId: 'lcg',
  ...
  {
    situation: { ...base, inning: 8, outs: 1, bases: bases(true, true, true), balls: 0, strikes: 0 },
    batterId: 'cjh',
    pitcherId: 'lcg',
  ...
  {
    situation: { ...base, inning: 8, outs: 2, bases: bases(true, true, true), balls: 3, strikes: 2 },
    batterId: 'kty',
    pitcherId: 'lcg',
  ...
  {
    situation: { ...base, inning: 9, outs: 0, bases: bases(false, false, false), balls: 0, strikes: 0 },
    batterId: 'ach',
    pitcherId: 'yyc',
  ...
  {
    situation: { ...base, inning: 9, outs: 1, bases: bases(true, true, false), balls: 1, strikes: 2 },
    batterId: 'hym',
    pitcherId: 'yyc',
  ...
  {
    situation: { ...base, inning: 9, outs: 2, bases: bases(true, true, true), balls: 3, strikes: 2 },
    batterId: 'nsh',
    pitcherId: 'yyc',
    outcome: '?',
    logLine: '타석 진행 중',
