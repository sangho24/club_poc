...
export const BATTERS: Batter[] = [
  {
    ...
    stat: {
      pa: 420, ab: 365, h: 105, double: 20, triple: 1, hr: 22,
      bb: 45, ibb: 3, hbp: 6, so: 88, sf: 4, sh: 0,
      sb: 4, cs: 2, r: 62, rbi: 78, gdp: 9,
      gbRate: 0.38, fbRate: 0.44, ldRate: 0.18,
  ...
  },
  {
    ...
    stat: {
      pa: 398, ab: 351, h: 98, double: 22, triple: 0, hr: 15,
      bb: 38, ibb: 4, hbp: 5, so: 71, sf: 4, sh: 0,
      sb: 1, cs: 1, r: 48, rbi: 71, gdp: 12,
  ...
  },
  {
    ...
    stat: {
      pa: 412, ab: 372, h: 112, double: 19, triple: 3, hr: 8,
      bb: 32, ibb: 1, hbp: 4, so: 52, sf: 4, sh: 0,
      sb: 12, cs: 4, r: 58, rbi: 47, gdp: 6,
      gbRate: 0.46, fbRate: 0.32, ldRate: 0.22,
  ...
  },
  {
    ...
    stat: {
      pa: 286, ab: 245, h: 62, double: 11, triple: 0, hr: 4,
      bb: 33, ibb: 2, hbp: 5, so: 48, sf: 3, sh: 0,
      sb: 0, cs: 1, r: 28, rbi: 30, gdp: 8,
      gbRate: 0.48, fbRate: 0.33, ldRate: 0.19,
      fieldingRuns: 8.0, positionAdj: POSITION_ADJ.C,
    },
  },
  {
    id: 'ach',
    ...
    stat: {
      pa: 375, ab: 336, h: 88, double: 17, triple: 1, hr: 9,
      bb: 30, ibb: 1, hbp: 4, so: 62, sf: 5, sh: 0,
      sb: 2, cs: 2, r: 41, rbi: 45, gdp: 11,
  ...
  },
  {
    ...
    stat: {
      pa: 405, ab: 358, h: 96, double: 18, triple: 4, hr: 13,
      bb: 38, ibb: 1, hbp: 5, so: 102, sf: 4, sh: 0,
      sb: 24, cs: 6, r: 61, rbi: 52, gdp: 4,
      gbRate: 0.41, fbRate: 0.39, ldRate: 0.2,
      fieldingRuns: 6.5, positionAdj: POSITION_ADJ.CF,
    },
  },
  {
    id: 'hym',
    ...
    stat: {
      pa: 224, ab: 201, h: 55, double: 9, triple: 2, hr: 3,
      bb: 17, ibb: 0, hbp: 3, so: 38, sf: 3, sh: 0,
      sb: 7, cs: 3, r: 30, rbi: 22, gdp: 5,
      gbRate: 0.5, fbRate: 0.3, ldRate: 0.2,
      fieldingRuns: 1.0, positionAdj: POSITION_ADJ.SS,
    },
  },
  {
    id: 'kty',
    ...
    stat: {
      pa: 268, ab: 240, h: 66, double: 13, triple: 0, hr: 7,
      bb: 22, ibb: 0, hbp: 3, so: 45, sf: 3, sh: 0,
      sb: 3, cs: 1, r: 32, rbi: 35, gdp: 6,
...
export const PITCHERS: Pitcher[] = [
  {
    ...
    stat: {
      g: 20, gs: 20, ipOuts: 384, h: 98, hr: 9, bb: 34, ibb: 1, hbp: 4,
      so: 158, r: 44, er: 41, w: 11, l: 4, sv: 0, hld: 0, bf: 520,
      gbRate: 0.42, fbRate: 0.38, ldRate: 0.2,
    },
  },
  {
    id: 'mdj',
    ...
    stat: {
      g: 20, gs: 20, ipOuts: 360, h: 108, hr: 10, bb: 42, ibb: 1, hbp: 5,
      so: 128, r: 52, er: 47, w: 9, l: 6, sv: 0, hld: 0, bf: 515,
      gbRate: 0.44, fbRate: 0.37, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 19, gs: 19, ipOuts: 342, h: 112, hr: 12, bb: 21, ibb: 2, hbp: 3,
      so: 96, r: 50, er: 46, w: 8, l: 6, sv: 0, hld: 0, bf: 483,
  ...
  },
  {
    ...
    stat: {
      g: 19, gs: 19, ipOuts: 351, h: 118, hr: 8, bb: 33, ibb: 1, hbp: 6,
      so: 104, r: 54, er: 49, w: 8, l: 5, sv: 0, hld: 0, bf: 514,
      gbRate: 0.54, fbRate: 0.28, ldRate: 0.18,
    },
  },
  {
    id: 'ksh',
    ...
    stat: {
      g: 44, gs: 0, ipOuts: 138, h: 33, hr: 2, bb: 19, ibb: 2, hbp: 2,
      so: 62, r: 14, er: 12, w: 3, l: 2, sv: 26, hld: 0, bf: 193,
  ...
  },
  {
    ...
    stat: {
      g: 48, gs: 0, ipOuts: 165, h: 44, hr: 3, bb: 11, ibb: 1, hbp: 2,
      so: 54, r: 18, er: 16, w: 4, l: 2, sv: 2, hld: 22, bf: 225,
      gbRate: 0.48, fbRate: 0.34, ldRate: 0.18,
    },
  },
];
