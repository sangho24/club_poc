...
export const BATTERS: Batter[] = [
  {
    ...
    stat: {
      ...
      bb: 44, ibb: 0, hbp: 4, so: 76, sf: 2, sh: 6,
      sb: 21, cs: 7, r: 66, rbi: 38, gdp: 5,
      gbRate: 0.48, fbRate: 0.32, ldRate: 0.2,
      fieldingRuns: 5.0, positionAdj: POSITION_ADJ.CF,
    },
  },
  {
    id: 'per',
    ...
    stat: {
      ...
      bb: 41, ibb: 2, hbp: 6, so: 108, sf: 3, sh: 0,
      sb: 9, cs: 4, r: 68, rbi: 74, gdp: 6,
      gbRate: 0.4, fbRate: 0.41, ldRate: 0.19,
      fieldingRuns: 1.0, positionAdj: POSITION_ADJ.RF,
    },
  },
  {
    id: 'mhb',
    ...
    stat: {
      ...
      bb: 40, ibb: 1, hbp: 5, so: 62, sf: 4, sh: 1,
      sb: 14, cs: 5, r: 64, rbi: 58, gdp: 7,
      gbRate: 0.45, fbRate: 0.34, ldRate: 0.21,
      fieldingRuns: 1.5, positionAdj: POSITION_ADJ.LF,
    },
  },
  {
    id: 'kbh',
    ...
    stat: {
      ...
      bb: 55, ibb: 5, hbp: 6, so: 78, sf: 5, sh: 0,
      sb: 2, cs: 1, r: 78, rbi: 90, gdp: 8,
      gbRate: 0.38, fbRate: 0.43, ldRate: 0.19,
      // 지명타자라 수비 가치가 없다. WAR 에서 포지션 조정이 가장 크게 깎이는 자리
      fieldingRuns: 0, positionAdj: POSITION_ADJ.DH,
    },
  },
  {
    id: 'nsh',
    ...
    stat: {
      ...
      bb: 52, ibb: 3, hbp: 7, so: 128, sf: 5, sh: 0,
      sb: 3, cs: 2, r: 72, rbi: 79, gdp: 10,
      gbRate: 0.4, fbRate: 0.42, ldRate: 0.18,
      fieldingRuns: 2.5, positionAdj: POSITION_ADJ['3B'],
    },
  },
  {
    id: 'ces',
    ...
    stat: {
      ...
      bb: 32, ibb: 3, hbp: 4, so: 58, sf: 4, sh: 0,
      sb: 1, cs: 0, r: 41, rbi: 62, gdp: 10,
      gbRate: 0.43, fbRate: 0.38, ldRate: 0.19,
      fieldingRuns: -1.0, positionAdj: POSITION_ADJ['1B'],
    },
  },
  {
    id: 'his',
    ...
    stat: {
      ...
      bb: 21, ibb: 1, hbp: 4, so: 52, sf: 2, sh: 5,
      sb: 1, cs: 1, r: 24, rbi: 26, gdp: 6,
      gbRate: 0.47, fbRate: 0.34, ldRate: 0.19,
      fieldingRuns: 6.0, positionAdj: POSITION_ADJ.C,
    },
  },
  {
    id: 'ldy',
    ...
    stat: {
      ...
      bb: 26, ibb: 0, hbp: 3, so: 55, sf: 3, sh: 8,
      sb: 8, cs: 3, r: 42, rbi: 33, gdp: 7,
      gbRate: 0.49, fbRate: 0.31, ldRate: 0.2,
      fieldingRuns: 2.0, positionAdj: POSITION_ADJ['2B'],
    },
  },
  {
    id: 'swj',
    ...
    stat: {
      ...
      bb: 27, ibb: 1, hbp: 4, so: 68, sf: 3, sh: 9,
      sb: 18, cs: 5, r: 48, rbi: 41, gdp: 6,
      gbRate: 0.47, fbRate: 0.33, ldRate: 0.2,
      fieldingRuns: 5.0, positionAdj: POSITION_ADJ.SS,
    },
  },
  {
    id: 'cjh',
    ...
    stat: {
      ...
      bb: 24, ibb: 1, hbp: 3, so: 34, sf: 2, sh: 3,
      sb: 0, cs: 0, r: 19, rbi: 20, gdp: 5,
      gbRate: 0.48, fbRate: 0.33, ldRate: 0.19,
      fieldingRuns: 7.0, positionAdj: POSITION_ADJ.C,
    },
  },
  {
    id: 'kty',
    ...
    stat: {
      ...
      bb: 19, ibb: 0, hbp: 3, so: 41, sf: 2, sh: 0,
      sb: 2, cs: 1, r: 27, rbi: 31, gdp: 5,
      gbRate: 0.43, fbRate: 0.38, ldRate: 0.19,
      fieldingRuns: -1.5, positionAdj: POSITION_ADJ.RF,
    },
  },
];
...
export const PITCHERS: Pitcher[] = [
  // ── 선발 ────────────────────────────────────────────────────
  {
    ...
    stat: {
      g: 20, gs: 20, ipOuts: 353, h: 112, hr: 7, bb: 17, ibb: 1, hbp: 4,
      so: 94, r: 42, er: 38, w: 10, l: 3, sv: 0, hld: 0, bf: 492,
      gbRate: 0.47, fbRate: 0.35, ldRate: 0.18,
    },
  },
  {
    id: 'mdj',
    ...
    stat: {
      g: 7, gs: 7, ipOuts: 114, h: 38, hr: 4, bb: 18, ibb: 0, hbp: 3,
      so: 36, r: 20, er: 18, w: 2, l: 3, sv: 0, hld: 0, bf: 176,
      gbRate: 0.44, fbRate: 0.37, ldRate: 0.19,
    },
  },
  {
    id: 'usb',
    ...
    stat: {
      g: 4, gs: 4, ipOuts: 51, h: 26, hr: 4, bb: 12, ibb: 0, hbp: 2,
      so: 11, r: 19, er: 18, w: 0, l: 3, sv: 0, hld: 0, bf: 93,
      gbRate: 0.41, fbRate: 0.4, ldRate: 0.19,
    },
  },
  {
    id: 'zim',
    ...
    stat: {
      g: 7, gs: 7, ipOuts: 117, h: 40, hr: 4, bb: 12, ibb: 0, hbp: 2,
      so: 33, r: 19, er: 17, w: 2, l: 3, sv: 0, hld: 0, bf: 172,
      gbRate: 0.45, fbRate: 0.37, ldRate: 0.18,
    },
  },
  {
    id: 'wht',
    ...
    stat: {
      g: 20, gs: 20, ipOuts: 372, h: 110, hr: 10, bb: 35, ibb: 1, hbp: 5,
      so: 132, r: 49, er: 45, w: 10, l: 5, sv: 0, hld: 0, bf: 525,
      gbRate: 0.43, fbRate: 0.38, ldRate: 0.19,
    },
  },
  ...
  // ── 마무리 ──────────────────────────────────────────────────
  {
    ...
    stat: {
      g: 38, gs: 0, ipOuts: 108, h: 32, hr: 3, bb: 22, ibb: 1, hbp: 3,
      so: 45, r: 18, er: 16, w: 2, l: 3, sv: 15, hld: 2, bf: 168,
      gbRate: 0.4, fbRate: 0.41, ldRate: 0.19,
    },
  },
  ...
  // ── 불펜 ────────────────────────────────────────────────────
  {
    ...
    stat: {
      g: 38, gs: 0, ipOuts: 114, h: 36, hr: 3, bb: 14, ibb: 0, hbp: 2,
      so: 34, r: 18, er: 16, w: 2, l: 2, sv: 0, hld: 8, bf: 168,
      gbRate: 0.46, fbRate: 0.35, ldRate: 0.19,
    },
  },
  {
    id: 'lhb',
    ...
    stat: {
      g: 45, gs: 0, ipOuts: 135, h: 44, hr: 3, bb: 15, ibb: 2, hbp: 3,
      so: 36, r: 20, er: 18, w: 3, l: 2, sv: 1, hld: 12, bf: 201,
      gbRate: 0.53, fbRate: 0.29, ldRate: 0.18,
    },
  },
  {
    id: 'lsk',
    ...
    stat: {
      g: 32, gs: 0, ipOuts: 93, h: 32, hr: 4, bb: 13, ibb: 0, hbp: 2,
      so: 26, r: 18, er: 17, w: 1, l: 2, sv: 0, hld: 5, bf: 143,
      gbRate: 0.42, fbRate: 0.39, ldRate: 0.19,
    },
  },
  {
    id: 'wyc',
    ...
    stat: {
      g: 22, gs: 20, ipOuts: 336, h: 108, hr: 9, bb: 40, ibb: 1, hbp: 5,
      so: 88, r: 52, er: 47, w: 7, l: 7, sv: 0, hld: 0, bf: 495,
      gbRate: 0.46, fbRate: 0.36, ldRate: 0.18,
    },
  },
  {
    id: 'lmw',
    ...
    stat: {
      g: 29, gs: 2, ipOuts: 138, h: 50, hr: 6, bb: 19, ibb: 1, hbp: 3,
      so: 33, r: 27, er: 25, w: 2, l: 3, sv: 0, hld: 4, bf: 214,
      gbRate: 0.44, fbRate: 0.38, ldRate: 0.18,
    },
  },
  {
    id: 'jyh',
    ...
    stat: {
      g: 11, gs: 0, ipOuts: 30, h: 12, hr: 1, bb: 7, ibb: 0, hbp: 1,
      so: 9, r: 8, er: 7, w: 0, l: 1, sv: 0, hld: 0, bf: 51,
      gbRate: 0.47, fbRate: 0.34, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 24, gs: 6, ipOuts: 150, h: 52, hr: 5, bb: 26, ibb: 1, hbp: 3,
      so: 44, r: 29, er: 26, w: 3, l: 3, sv: 0, hld: 3, bf: 235,
      gbRate: 0.43, fbRate: 0.38, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 35, gs: 0, ipOuts: 87, h: 28, hr: 2, bb: 12, ibb: 2, hbp: 1,
      so: 27, r: 14, er: 12, w: 1, l: 1, sv: 0, hld: 9, bf: 131,
      gbRate: 0.45, fbRate: 0.36, ldRate: 0.19,
    },
  },
  {
    id: 'jih',
    ...
    stat: {
      g: 27, gs: 0, ipOuts: 78, h: 27, hr: 3, bb: 12, ibb: 0, hbp: 2,
      so: 22, r: 15, er: 14, w: 1, l: 2, sv: 0, hld: 3, bf: 121,
      gbRate: 0.46, fbRate: 0.35, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 41, gs: 0, ipOuts: 120, h: 38, hr: 3, bb: 16, ibb: 1, hbp: 2,
      so: 35, r: 19, er: 17, w: 2, l: 2, sv: 0, hld: 11, bf: 180,
      gbRate: 0.48, fbRate: 0.33, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 22, gs: 0, ipOuts: 63, h: 23, hr: 3, bb: 11, ibb: 0, hbp: 2,
      so: 18, r: 14, er: 13, w: 1, l: 1, sv: 0, hld: 2, bf: 101,
      gbRate: 0.44, fbRate: 0.37, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 47, gs: 0, ipOuts: 144, h: 42, hr: 3, bb: 15, ibb: 2, hbp: 3,
      so: 47, r: 18, er: 16, w: 3, l: 2, sv: 2, hld: 18, bf: 207,
      gbRate: 0.47, fbRate: 0.34, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 19, gs: 0, ipOuts: 54, h: 20, hr: 2, bb: 10, ibb: 0, hbp: 1,
      so: 15, r: 12, er: 11, w: 1, l: 1, sv: 0, hld: 2, bf: 88,
      gbRate: 0.45, fbRate: 0.36, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 9, gs: 0, ipOuts: 24, h: 10, hr: 1, bb: 6, ibb: 0, hbp: 1,
      so: 7, r: 7, er: 6, w: 0, l: 0, sv: 0, hld: 1, bf: 42,
      gbRate: 0.46, fbRate: 0.35, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 16, gs: 0, ipOuts: 45, h: 17, hr: 2, bb: 9, ibb: 0, hbp: 1,
      so: 13, r: 10, er: 9, w: 0, l: 1, sv: 0, hld: 2, bf: 74,
      gbRate: 0.47, fbRate: 0.34, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 25, gs: 0, ipOuts: 72, h: 25, hr: 2, bb: 11, ibb: 1, hbp: 2,
      so: 21, r: 13, er: 12, w: 1, l: 1, sv: 0, hld: 4, bf: 113,
      gbRate: 0.48, fbRate: 0.33, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 20, gs: 1, ipOuts: 66, h: 24, hr: 3, bb: 12, ibb: 0, hbp: 2,
      so: 19, r: 15, er: 14, w: 1, l: 2, sv: 0, hld: 2, bf: 106,
      gbRate: 0.43, fbRate: 0.38, ldRate: 0.19,
    },
  },
  {
    ...
    stat: {
      g: 31, gs: 3, ipOuts: 147, h: 53, hr: 6, bb: 21, ibb: 1, hbp: 3,
      so: 36, r: 29, er: 27, w: 2, l: 4, sv: 0, hld: 5, bf: 229,
      gbRate: 0.45, fbRate: 0.37, ldRate: 0.18,
    },
  },
];
...
export const OPPONENT_PITCHERS: Pitcher[] = [
  {
    ...
    stat: {
      g: 19, gs: 19, ipOuts: 330, h: 116, hr: 13, bb: 38, ibb: 2, hbp: 4,
      so: 88, r: 58, er: 53, w: 7, l: 7, sv: 0, hld: 0, bf: 492,
      gbRate: 0.39, fbRate: 0.42, ldRate: 0.19,
    },
  },
  {
    id: 'sjy',
    ...
    stat: {
      g: 18, gs: 18, ipOuts: 321, h: 104, hr: 7, bb: 35, ibb: 1, hbp: 5,
      so: 92, r: 47, er: 43, w: 8, l: 5, sv: 0, hld: 0, bf: 470,
      gbRate: 0.53, fbRate: 0.29, ldRate: 0.18,
    },
  },
  {
    ...
    stat: {
      g: 46, gs: 0, ipOuts: 144, h: 40, hr: 4, bb: 16, ibb: 1, hbp: 3,
      so: 53, r: 18, er: 16, w: 3, l: 3, sv: 24, hld: 0, bf: 205,
      gbRate: 0.43, fbRate: 0.39, ldRate: 0.18,
    },
  },
  {
    id: 'hdj',
    ...
    stat: {
      g: 51, gs: 0, ipOuts: 132, h: 38, hr: 3, bb: 14, ibb: 2, hbp: 2,
      so: 48, r: 17, er: 15, w: 2, l: 3, sv: 1, hld: 19, bf: 190,
      gbRate: 0.46, fbRate: 0.35, ldRate: 0.19,
    },
  },
];
...
export const PREV_BATTER: Record<string, BatterStatLine> = {
  nsh: pb({
    g: 133,
    pa: 543, ab: 476, h: 126, double: 24, triple: 1, hr: 27,
    bb: 55, ibb: 2, hbp: 8, so: 130, sf: 4, sh: 0,
    sb: 4, cs: 2, r: 78, rbi: 89, gdp: 12,
  }),
  ces: pb({
    g: 126,
    pa: 512, ab: 458, h: 128, double: 26, triple: 0, hr: 18,
    bb: 44, ibb: 3, hbp: 6, so: 88, sf: 4, sh: 0,
    sb: 2, cs: 1, r: 62, rbi: 84, gdp: 14,
  }),
  mhb: pb({
    g: 138,
    pa: 561, ab: 505, h: 148, double: 24, triple: 4, hr: 10,
    bb: 44, ibb: 1, hbp: 7, so: 72, sf: 5, sh: 0,
    sb: 16, cs: 6, r: 76, rbi: 65, gdp: 8,
  }),
  // 이적 전 소속팀에서의 기록이다. 팀이 달라도 같은 리그라 견줄 수 있다
  kbh: pb({
    g: 116,
    pa: 468, ab: 411, h: 116, double: 22, triple: 1, hr: 19,
    bb: 48, ibb: 4, hbp: 5, so: 74, sf: 4, sh: 0,
    sb: 3, cs: 2, r: 61, rbi: 71, gdp: 11,
  }),
  swj: pb({
    g: 118,
    pa: 421, ab: 375, h: 94, double: 15, triple: 4, hr: 5,
    bb: 29, ibb: 0, hbp: 5, so: 78, sf: 3, sh: 9,
    sb: 24, cs: 8, r: 52, rbi: 38, gdp: 7,
  }),
  ldy: pb({
    g: 92,
    pa: 288, ab: 253, h: 63, double: 9, triple: 1, hr: 2,
    bb: 22, ibb: 0, hbp: 3, so: 46, sf: 2, sh: 8,
    sb: 6, cs: 3, r: 31, rbi: 24, gdp: 6,
  }),
  his: pb({
    g: 38,
    pa: 96, ab: 84, h: 18, double: 3, triple: 0, hr: 0,
    bb: 8, ibb: 0, hbp: 2, so: 24, sf: 1, sh: 1,
    sb: 0, cs: 0, r: 8, rbi: 7, gdp: 2,
  }),
  lws: pb({
    g: 74,
    pa: 214, ab: 189, h: 48, double: 8, triple: 2, hr: 2,
    bb: 20, ibb: 0, hbp: 2, so: 42, sf: 1, sh: 2,
    sb: 9, cs: 4, r: 28, rbi: 16, gdp: 3,
  }),
  cjh: pb({
    g: 88,
    pa: 298, ab: 252, h: 63, double: 10, triple: 0, hr: 3,
    bb: 38, ibb: 1, hbp: 5, so: 52, sf: 3, sh: 0,
    sb: 0, cs: 1, r: 28, rbi: 29, gdp: 9,
  }),
  kty: pb({
    g: 96,
    pa: 312, ab: 279, h: 76, double: 14, triple: 1, hr: 8,
    bb: 26, ibb: 0, hbp: 4, so: 54, sf: 3, sh: 0,
    sb: 4, cs: 2, r: 38, rbi: 42, gdp: 7,
  }),
...
export const PREV_PITCHER: Record<string, PitcherStatLine> = {
  ryu: pp({
    g: 28, gs: 28, ipOuts: 465, h: 158, hr: 14, bb: 34, ibb: 2, hbp: 5,
    so: 118, r: 66, er: 61, w: 10, l: 8, bf: 668,
  }),
  mdj: pp({
    g: 21, gs: 21, ipOuts: 336, h: 106, hr: 9, bb: 48, ibb: 1, hbp: 6,
    so: 106, r: 54, er: 49, w: 7, l: 7, bf: 500,
  }),
  // 이적 전 소속팀 기록. 78억 FA 의 근거가 된 해다
  usb: pp({
    g: 27, gs: 24, ipOuts: 396, h: 132, hr: 16, bb: 46, ibb: 1, hbp: 7,
    so: 108, r: 68, er: 62, w: 8, l: 9, bf: 588,
  }),
  ksh: pp({
    g: 55, gs: 0, ipOuts: 174, h: 42, hr: 3, bb: 30, ibb: 2, hbp: 4,
    so: 68, r: 20, er: 17, w: 3, l: 4, sv: 21, hld: 6, bf: 252,
  }),
  kmw: pp({
    g: 26, gs: 8, ipOuts: 216, h: 80, hr: 8, bb: 32, ibb: 1, hbp: 4,
    so: 52, r: 44, er: 40, w: 3, l: 6, bf: 336,
  }),
  kbj: pp({
    g: 42, gs: 0, ipOuts: 132, h: 40, hr: 4, bb: 18, ibb: 1, hbp: 3,
    so: 38, r: 21, er: 19, w: 2, l: 3, sv: 1, hld: 12, bf: 196,
  }),
  lhb: pp({
    g: 39, gs: 0, ipOuts: 111, h: 40, hr: 4, bb: 16, ibb: 2, hbp: 2,
    so: 26, r: 22, er: 20, w: 2, l: 3, sv: 0, hld: 8, bf: 172,
  }),
...
export function verifyRoster(): string[] {
  ...
  const batterLines: [string, BatterStatLine][] = [
    ...
    ...Object.entries(PREV_BATTER).map(
      ([id, l]) => [`${id}(2025)`, l] as [string, BatterStatLine],
    ),
  ];
